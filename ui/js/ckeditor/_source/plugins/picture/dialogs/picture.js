...
(function()
{
	...
	CKEDITOR.dialog.add( 'picture', function( editor )
		{
			return imageDialog( editor, 'picture' );
		});

	CKEDITOR.dialog.add( 'picturebutton', function( editor )
		{
			return imageDialog( editor, 'picturebutton' );
		});
})();
